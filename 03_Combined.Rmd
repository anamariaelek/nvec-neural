...
## In-silico ChIP edge score

```{r}
minmax <- function(x, na.rm = TRUE) {
    (x - min(x)) / (max(x) - min(x))
}
#' @param s numeric, correlation between the chromatin accessibility of peak i
#'   and the RNA expression of TF j
#' @param r numeric, motif score for TF j in peak i
#' @param p numeric, maximum chromatin accessibility of peak i
#'   across all samples
insilico_chip <- function(s, r, p) {
  s * minmax(r * p)
}
```
