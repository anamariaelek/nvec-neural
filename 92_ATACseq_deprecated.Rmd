...
clusters_bed[, group := factor(
  group, levels = paste0("G", seq_along(unique(group)))
)]
...
Use quantile based motif scores (instead of motif scoring implemented in TOBIAS BINDetect) to determine motif binding.
...
More simple approach - for TFs, find all genes they are assigned to
