...
```{bash eval=FALSE}
conda activate TOBIAS_ENV
bwg_dir="ATACSEQ/nucleosome_free_regions/bigwig/"
...
do
  ...
  mkdir ${out_dir}/${line}
  echo $(date) "- Starting BINDetect for" ${line} 
  ...
  TOBIAS BINDetect \
    ...
    --peaks ${peaks} \
    --outdir ${out_dir}/${line} \
    --cond_names ${line}_pos ${line}_neg \
    --cores ${nth}
...
TOBIAS PlotAggregate \
  --TFBS \
    ${out_dir}/${line}/_${mot}/beds/_${mot}_${line}_${cond}_bound.bed \
    ${out_dir}/${line}/_${mot}/beds/_${mot}_${line}_${cond}_unbound.bed \
  --signals \
...
names(bkg_dist) <- str_remove(names(bkg_dist), "_footprints")
