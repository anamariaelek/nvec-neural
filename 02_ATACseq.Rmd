...
TOBIAS PlotAggregate \
  --TFBS ${out_dir}/${x}/${mot}/beds/${mot}_Ncol_pos_bound.bed ${out_dir}/${x}/${mot}/beds/${mot}_Ncol_pos_unbound.bed \
  --signals ${bwg_dir}/ATACorrect/Ncol_pos_corrected.bw ${bwg_dir}/ATACorrect/Ncol_neg_corrected.bw \
  --output ${out_dir}/${x}/${mot}/plots/${mot}_footprint.png --share_y sites --plot_boundaries

# GATA
mot="_ARCH738_GATA_Nvec_vc1.1_XM_032"
TOBIAS PlotAggregate \
  --TFBS ${out_dir}/${x}/${mot}/beds/${mot}_Elav_pos_bound.bed ${out_dir}/${x}/${mot}/beds/${mot}_Elav_pos_unbound.bed \
  --signals ${bwg_dir}/ATACorrect/Elav_pos_corrected.bw ${bwg_dir}/ATACorrect/Elav_neg_corrected.bw \
  --output ${out_dir}/${x}/${mot}/plots/${mot}_footprint.png --share_y sites --plot_boundaries
