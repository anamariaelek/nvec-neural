...
# parse only motif + gene + dample info
mo_dt <- unique(bound_dt[order(score)][, .SD[1], .(motif, gene, sample)][, .(
  motif, motif_name, gene, name, pfam, sample
)])
mo_dt[, n_samples := length(unique(.SD$sample)), .(motif, gene)]
